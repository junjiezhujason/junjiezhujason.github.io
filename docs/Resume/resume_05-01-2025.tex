...
I have had extensive experince working with world-class scientists and top-tier product teams to create collective impact. 
Drawn to complex problems and high-agency teams, I build scalable solutions that leverage insights from evolving domains: 
multi-modal RAGs, intelligent search systems, and biomedical breakthroughs.

% TODO: make this more colorful and fun to read.
