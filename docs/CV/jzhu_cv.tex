...
\vspace{0.02in}
\cvline{}{\sstitle{Software development}: Data Mining and Visualization (pandas, D3.js);Machine Learning Modeling (scikit-learn, TensorFlow, Keras); Full-Stack Engineering (Flask, jQuery); Graph-Based Algorithm Design and Data Structures, UI Design.}
\vspace{0.02in}
...
\begin{enumerate}
\item
``Exploratory gene ontology analysis with interactive visualization'',  \textbf{J. Zhu}, Q. Zhao, E. Katsevich, C. Sabatti, \textit{under review}.
\item
