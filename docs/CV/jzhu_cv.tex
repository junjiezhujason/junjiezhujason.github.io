...
\newline Analyze complex data sets with high-dimensional statistics and large-scale computing; Apply machine learning in information retrieval domain including search engines, natural language processing, or similar areas; Develop new testing strategies for software services at the intersection of user experience and computational algorithms; Software Development in Java, C++, and Python.
}
\vspace{-0.05in}
