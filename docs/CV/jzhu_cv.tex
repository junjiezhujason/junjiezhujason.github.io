...
\newline \textit{Advisor: Prof. Chiara Sabatti}
 {\newline
Developing graph visualization techniques to interpret and analyze the Gene Ontology (GO); implementing single-cell RNA-sequencing secondary data analysis pipelines for stem-cell and cancer modeling systems; proposing selective inference methods to study tissue-specific expression quantitative trait loci (eQTLs).
}}
\vspace{-0.05in}
\cvline{06/17 - 09/17}{\textbf{Deep Learning Intern},  Illumina, San Francisco,  CA
\newline \textit{Mentor: Prof. Serafim Batzoglou}
