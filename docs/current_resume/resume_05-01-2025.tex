...
\begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  ...
  \multicolumn{2}{l}{
    \begin{minipage}{\textwidth}
      ...
      \begin{itemize}[leftmargin=*, itemsep=-4.5pt, topsep=0pt, label={\raisebox{0.4ex}{\tiny\textbullet}}]
        \item Graph Theory: Discovered the optimal distance-2 coloring assignments (which applies to the radio frequency assignment problem) for various graph families with combinatorial algorithms and co-authored five publications in discrete math journals.
        \item Information Theory: Derived mathamtical solutions for stochastic geometric models to analyze wireless network interference with multi-antenna systems, resulting in three first-author publications in flagship IEEE conferences.
      \end{itemize}
    \end{minipage}
  } \\
\end{tabular*}
