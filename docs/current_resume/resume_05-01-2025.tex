...
\begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  ...
  \multicolumn{2}{l}{
    \begin{minipage}{\textwidth}
      ...
      \begin{itemize}[leftmargin=*, itemsep=-4.5pt, topsep=0pt, label={\raisebox{0.4ex}{\tiny\textbullet}}]
        ...
        \item  Research: Architecting next-generation AI applications using emerging protocols (e.g., MCP, A2A). % TODO: add additional model types
        \item  Results: Pioneering privacy-first RAG systems with lightweight AI models and edge vision processing. % TODO: mention how long it took to build this
      \end{itemize}
    \end{minipage}
  } \\
  \noalign{\vspace{0.7em}}
  ...
  \multicolumn{2}{l}{
    \begin{minipage}{\textwidth}
      ...
      \begin{itemize}[leftmargin=*, itemsep=-4.5pt, topsep=0pt, label={\raisebox{0.4ex}{\tiny\textbullet}}]       
        ...
        \item  Synthetic Data Generation: Pioneered robust frameworks using advanced dimensional perturbation techniques. % TODO: add metrics (based on the paper)
        \item  Preference Learning: Designed offline A/B testing to capture preference dynamics and distribution shifts. % TODO: remove and update
        \item  Query Intent Testing: Built high-performance Java pipelines for Maps Search query understanding evaluation. 
        \item  Ranking Triage: Proposed and implemented linear-time algorithms to debug and improve multi-ranker systems. % TODO: add metrics
      \end{itemize}
    \end{minipage}
  } \\
  \noalign{\vspace{0.7em}}
  ...
  \multicolumn{2}{l}{
    \begin{minipage}{\textwidth}
      \vspace{0.3em}
      \begin{itemize}[leftmargin=*, itemsep=-4.5pt, topsep=0pt, label={\raisebox{0.4ex}{\tiny\textbullet}}]
        \item  Graph Visualization: Engineered interactive visualizations for Gene Ontology analysis. % TODO: add something highlightable (full-stack, js) 
        \item  Unsupervised Learning: Developed novel dimension-reduction techniques for cellular modeling. % TODO: add citation metrics and "Impact Section"
        \item  Statistical Inference: Enhanced multiple-hypothesis testing to eliminate data snooping bias. % TODO: add statisical methodology
        \item  Selective Inference: Implemented advanced methods for tissue-specific eQTL analysis. % TODO: add something highlightable
        \item  Sequence Alignment: Enhanced DNA sequence alignment performance through C/C++ optimization. % TODO: remove
      \end{itemize}
    \end{minipage}
  } \\
  \noalign{\vspace{0.7em}}
