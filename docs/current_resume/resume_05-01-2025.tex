  ...
  \multicolumn{2}{l}{
    \begin{minipage}{\textwidth}
      ...
      \begin{itemize}[leftmargin=*, itemsep=-4.5pt, topsep=0pt, label={\raisebox{0.4ex}{\tiny\textbullet}}]       
        ...
        % \item {\bf Roadmap Leadership}: Spearheaded the development and rollout of an offline evaluation framework to quantify feature impact on user experience, driving a shift to data-driven releases and reducing manual processes. Owned multi-year roadmap strategy and stakeholder alignment, enabling a 5-person team to pursue new initiatives and ensuring the roadmap’s continuity beyond my tenure.
        % \item {\bf Initiative Growth}: Spearheaded the development and rollout of an offline evaluation framework to continues quantify feature impact on user experience, enabling faster improvement cycles. Owned multi-year roadmap strategy and stakeholder alignment.
        % Scaled the initiative from a solo effort to a 5-person team, empowering members to independently drive new scopes and sustain the roadmap beyond my tenure.
